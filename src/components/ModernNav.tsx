// Enhanced by AI on 2025-08-08T15:30:18.548Z
// Section: navigation
// Category: navigation
...
import { Menu, X, ArrowRight, Factory, Settings } from "lucide-react"
import { cn } from "@/lib/utils"

export default function Navbar() {
  const [isOpen, setIsOpen] = useState(false)

  // Updated navigation to match ACTUAL website structure
  const navigation = [
    { name: "Home", href: "/" },
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                <Factory className="text-primary-foreground size-4" />
              </div>
              <span className="font-bold text-xl">ManufacturePro</span>
            </Link>
          </div>
