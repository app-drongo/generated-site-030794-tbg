// Enhanced by AI on 2025-08-08T15:29:37.650Z
// Section: hero
// Category: hero

// components/hero/SplitHero.tsx
import { Button } from "@/components/ui/button"
import { ArrowRight, CheckCircle2, Factory, ShieldCheck, Settings, BarChart } from "lucide-react"
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Expert SAP consulting services to streamline your manufacturing operations, reduce costs, and increase productivity with tailored solutions.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Link href="/">
                <Button size="lg" variant="outline" className="text-base">
                  <Factory className="mr-2 size-5" /> Manufacturing Solutions
                </Button>
              </Link>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  src="https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?q=80&w=1920&auto=format&fit=crop"
                  alt="Modern manufacturing facility with SAP integration"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm flex items-center">
                <BarChart className="size-4 mr-1 text-primary" />
                <span className="font-semibold">30%</span> Improvement
              </p>
            </div>
